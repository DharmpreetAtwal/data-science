...
# %%
# Use RandomUnderSampler to create a syntetic dataset with no class imbalance
# Perform feature selection on this syntetic dataset 
...
data_scaled = scaler.fit_transform(df_features_reduced)
